    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://*.posthog.com https://*.vercel-insights.com https://*.onrelay.app; frame-ancestors 'none'" },
