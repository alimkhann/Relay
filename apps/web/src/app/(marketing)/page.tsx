      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-[140vh] overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, transparent 0%, rgba(255,255,255,0.04) 10%, rgba(255,255,255,0.12) 22%, rgba(255,255,255,0.25) 36%, rgba(255,255,255,0.45) 50%, rgba(255,255,255,0.7) 65%, rgba(255,255,255,0.88) 80%, rgba(255,255,255,0.97) 92%, white 100%)",
            }}
          />
          ...
          <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
            <div className="max-w-3xl" data-animate="hero">
              <h1 className="text-5xl font-bold leading-[1.02] tracking-[-0.035em] text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.15)] md:text-7xl lg:text-[5.5rem]">
                Relay your context
                <br className="hidden md:block" /> between AIs
              </h1>
              <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-white/80 md:text-xl">
                Relay saves what matters from your AI work and inserts a clean
                project brief into the next fresh chat.
              </p>
              <div className="mt-10">
                <Link
                  href="/sign-in"
            ...
            >
              ...
              <div className="flex items-center gap-8">
                {platforms.map((p) => (
                  <span
                    key={p}
                    className="text-sm font-semibold tracking-wide text-white/55"
                  >
                    {p}
                  </span>
                ))}
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-1">
              {steps.map((step) => (
                <div
                  key={step.num}
                  className="group flex gap-6 border-b border-gray-100 py-8 first:border-t md:gap-10"
                  data-animate="step"
                >
                  <span className="mt-1 text-sm font-bold tabular-nums text-gray-300">
                    {step.num}
                  </span>
