export default function ConceptsDocsPage() {
  return (
    <div className="max-w-2xl space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-[var(--relay-ink)]">Entitlements &amp; plans</h2>
        <p className="text-[15px] text-[var(--relay-muted)]">
          Relay enforces plan-based limits on usage:
        </p>
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-[var(--relay-line)]">
                <th className="px-4 py-2.5 text-left font-semibold text-[var(--relay-ink)]">Limit</th>
                <th className="px-4 py-2.5 text-right font-semibold text-[var(--relay-ink)]">Free</th>
                <th className="px-4 py-2.5 text-right font-semibold text-[var(--relay-ink)]">Pro</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[var(--relay-line)]">
              {[
                ...
                <tr key={row.label}>
                  <td className="px-4 py-2.5 text-[var(--relay-muted)]">{row.label}</td>
                  <td className="px-4 py-2.5 text-right text-[var(--relay-muted)]">{row.free}</td>
                  <td className="px-4 py-2.5 text-right text-[var(--relay-ink)] font-medium">{row.pro}</td>
                </tr>
              ))}
            </tbody>
          </table>
