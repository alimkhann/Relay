              ...
              {editingId === c.id ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="p-1 text-[var(--relay-muted)] opacity-100 transition-opacity hover:text-[var(--relay-ink)] sm:opacity-0 sm:group-hover:opacity-100"
                  >
                  ...
                  <button
                    ...
                    className="p-1 text-[var(--relay-muted)] opacity-100 transition-opacity hover:text-[var(--relay-danger)] sm:opacity-0 sm:group-hover:opacity-100"
                  >
