                    ...
                    {editingId === c.id ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          aria-label="Rename"
                          className="opacity-0 transition-opacity group-hover:opacity-100 rounded-[var(--relay-radius-sm)] p-1 text-[var(--relay-muted)] hover:bg-[var(--relay-soft-hover)] hover:text-[var(--relay-ink)]"
                        >
