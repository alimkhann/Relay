        ...
        >
          {item.kind === "session" ? (
            <>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[var(--relay-faint)]">
                  {item.data.platform} · {item.data.turnCount} turns ·{" "}
                  {formatTime(item.data.capturedAt)}
                </p>
              </div>
            </>
          ) : (
            <>
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm text-[var(--relay-ink-secondary)]">
                  {item.data.summaryShort}
                </p>
                <p className="text-xs text-[var(--relay-faint)]">
                  Learned from recent chat
                </p>
              </div>
            </>
          )}
