const { Pool } = require(require("path").resolve(__dirname, "../node_modules/.pnpm/@neondatabase+serverless@1.0.2/node_modules/@neondatabase/serverless"));
...
async function main() {
  ...
  if (action === "count") {
    const tables = [
      "profiles", "projects", "project_members", "source_sessions", "source_turns",
      "memory_items", "context_packets", "bootstrap_packets", "session_digests",
      "project_state", "ai_job_runs", "capture_events", "project_bindings",
      "user_settings", "extension_api_tokens", "extension_connect_grants", "target_profiles"
    ];
