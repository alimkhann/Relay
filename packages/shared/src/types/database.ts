...
import type {
  canonEntryKinds,
  canonEntryStatuses,
  canonEvidenceSourceKinds,
  projectSummarySnapshotKinds,
...
export type CanonEntryKind = (typeof canonEntryKinds)[number]
export type CanonEntryStatus = (typeof canonEntryStatuses)[number]
export type CanonEvidenceSourceKind = (typeof canonEvidenceSourceKinds)[number]
export type ProjectSummarySnapshotKind = (typeof projectSummarySnapshotKinds)[number]
...
export interface CanonEvidenceRow {
  id: string
  projectId: string
  canonEntryId: string
...
export interface ProjectSummarySnapshotRow {
  id: string
  projectId: string
...
export type ProjectAutonomyMode = "conservative" | "standard" | "aggressive"
export type ProjectCompactionMode = "light" | "standard" | "aggressive"
