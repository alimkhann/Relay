...
export interface ProjectDashboardDto {
  ...
  /** Count of distinct conversations (by sourceConversationId or URL), not total capture rows */
...
export interface CanonEvidenceDto {
  id: string
...
export interface CanonEntryDto {
  ...
  createdAt: string
  updatedAt: string
  evidence?: CanonEvidenceDto[]
}

export interface ProjectSummarySnapshotDto {
  id: string
